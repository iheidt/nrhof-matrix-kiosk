...
from ..fonts import render_mixed_text
...
def draw_button(
    ...
    **overrides,
    ...
    adornment_margin = overrides.get(
        "adornment_margin_left",
        adornment_config.get("margin_left", 18),
    )
    ...
    if adornment_type == "square":
        ...
        pygame.draw.rect(
            surface,
            adornment_color,
            (adornment_x, adornment_y, adornment_size, adornment_size),
            0,
        )
...
def draw_toggle_button(
    ...
    **overrides,
    ...
    # Font - use localized font for Japanese support
    from nrhof.ui.fonts import get_theme_font, render_mixed_text

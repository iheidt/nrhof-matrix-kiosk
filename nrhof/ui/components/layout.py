...
def draw_back_arrow(surface: Surface, color: tuple = (140, 255, 140)) -> pygame.Rect:
    ...
    """
    from nrhof.ui.components import MARGIN_LEFT, MARGIN_TOP
...
def draw_status(surface: Surface, color: tuple = (140, 255, 140)):
    ...
    from nrhof.core.theme_loader import get_theme_loader
    from nrhof.ui.fonts import get_localized_font
...
def draw_hud(surface: Surface, color: tuple = (0, 255, 0)):
    ...
    """
    from nrhof.core.observability import get_performance_hud
    from nrhof.core.theme_loader import get_theme_loader

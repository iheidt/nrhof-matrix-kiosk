...
class ModelRenderer:
    ...
    def load_model(self, model_path: str) -> NodePath | None:
        ...
        Args:
            model_path: Path to model file (GLB, GLTF, BAM, EGG, etc.)
        ...
        try:
            ...
            from panda3d.core import LVecBase4f, Material, TextureAttrib
            ...
            for node in self.model.findAllMatches("**/+GeomNode"):
                ...
                if node.hasMaterial():
                    ...
                    print(
                        f"  Original Material: ambient={mat.getAmbient()}, diffuse={mat.getDiffuse()}"
                    )
                    ...
                    new_mat.setDiffuse(
                        LVecBase4f(1.0, 1.0, 1.0, 1.0)
                    )  # Bright diffuse (was 0.125!)
    ...
    def set_emission_strength(self, strength: float, hex_color: str | None = None):

...
class ThemeLoader:
    ...
    def __init__(self, root_dir: Path = None):
        ...
        """
        if root_dir is None:
            # Go up from nrhof/core/theme_loader.py to project root
            # __file__ -> nrhof/core/ -> nrhof/ -> project root (3 levels)
    ...
    def load_theme(self, scene_name: str, theme_name: str = "pipboy") -> dict[str, Any]:
        ...
        # Merge all three
        theme = {"content": content, "layout": layout, "style": style}
    ...
    def _resolve_font_sizes(self, layout: dict, font_sizes: dict) -> dict:
        ...
        for _key, value in resolved.items():

    ...
    if _d20_renderer is not None:
        try:
            ...
            if not _d20_is_dragging:
                ...
                time_since_interaction = current_time - _d20_last_interaction if _d20_last_interaction else 999
                ...
                if time_since_interaction > attractor_delay:
                    ...
                    if abs(_d20_velocity_r) < 25.0:
                        target_spin = _d20_north_star_spin if _d20_velocity_r >= 0 else -_d20_north_star_spin
            ...
            _d20_renderer.set_emission_strength(2.5, primary_hex)  # Moderate glow (scaled from 0.41)

...
class Shape:
    ...
    @classmethod
    def rect(cls, x: float, y: float, w: float, h: float, color: Tuple[int, int, int], 
             thickness: int = 0, alpha: int = 255):
    ...
    @classmethod
    def circle(cls, x: float, y: float, radius: float, color: Tuple[int, int, int],
               thickness: int = 0, alpha: int = 255):
    ...
    @classmethod
    def line(cls, points: List[Tuple[float, float]], color: Tuple[int, int, int],
             thickness: int = 1, alpha: int = 255):
    ...
    @classmethod
    def polygon(cls, points: List[Tuple[float, float]], color: Tuple[int, int, int],
                thickness: int = 0, alpha: int = 255):
...
class Text:
    ...
    def create(cls, content: str, x: float, y: float, color: Tuple[int, int, int],
               font_size: int = 24, mono: bool = True, alpha: int = 255):
...
class Image:
    ...
    position: Tuple[float, float]
    size: Optional[Tuple[float, float]] = None  # None = original size
    alpha: int = 255

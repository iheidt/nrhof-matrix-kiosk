...
class AppState:
    ...
    def get_ambient_song(self) -> TrackInfo | None:
    ...
    # Track state methods
    def set_current_track(self, track: TrackInfo | None):
        """Set current track.

...
from core.now_playing import Track, get_now_playing_state
...
class SourceManager:
    ...
    PRIORITY = {"spotify": 1, "sonos": 2, "vinyl": 3}
    ...
    def __init__(self, config: dict):
        ...
        self.min_change_interval = config.get("source_manager", {}).get(
            "min_change_interval_seconds",
            2.0,
        )
        self.confidence_threshold = config.get("source_manager", {}).get(
    ...
    def set_from(
        self,
        source: Literal["spotify", "sonos", "vinyl"],
        track: Track | None,
    ) -> bool:
